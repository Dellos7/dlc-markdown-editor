import { r as registerInstance, c as createEvent, d as getConnect, h, e as getElement } from './dlc-markdown-editor-d387313e.js';
...
class DefaultStylerFactory {
    ...
    style(styler) {
        ...
        let selectedText = SelectionTextUtils.getSelectionText(this.element);
...
class DlcMarkdownEditor {
    constructor(hostRef) {
        ...
        this.toastCtrl = getConnect(this, "ion-toast-controller");
    }
    ...
    async showPreviewer() {
        ...
        setTimeout(() => {
            let editor = this.el.shadowRoot.querySelector('.editor-wrapper');
