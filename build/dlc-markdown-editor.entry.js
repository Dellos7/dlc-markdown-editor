...
class DlcMarkdownEditor {
    ...
    render() {
        this.updateMarkdownPreview();
        return (h("div", { class: "wrapper", part: "container" }, h("div", { class: "editor-wrapper" }, h("div", { class: "buttons" }, h("button", { class: "button button-bold", onClick: _ => this.bold() }, h("strong", null, "B")), h("button", { class: "button button-italics", onClick: _ => this.italics() }, h("i", null, "I")), h("button", { class: "button button-link", onClick: _ => this.link() }, h("ion-icon", { name: "link" })), h("button", { class: "button button-h1", onClick: _ => this.h1() }, "H", h("sub", null, "1")), h("button", { class: "button button-h1", onClick: _ => this.h1() }, "H", h("sub", null, "2")), h("button", { class: "button button-h1", onClick: _ => this.h1() }, "H", h("sub", null, "3"))), h("div", { class: "editor-wrapper__area", innerHTML: this.getEditorElementHtml() })), h("div", { class: "previewer", part: "previewer", innerHTML: this.markdownText })));
    }
